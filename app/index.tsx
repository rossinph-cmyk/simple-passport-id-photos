...
const styles = StyleSheet.create({
  ...
  scrollView: { flex: 1 },
  header: { backgroundColor: 'rgba(255, 255, 255, 0.98)', paddingVertical: 20, paddingHorizontal: 20, borderBottomWidth: 1, borderBottomColor: '#e9ecef', position: 'relative' },
  ...
  themeButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginHorizontal: 20, marginBottom: 15, paddingVertical: 12, paddingHorizontal: 15, backgroundColor: 'rgba(255, 255, 255, 0.98)', borderRadius: 12, borderWidth: 1, borderColor: '#dee2e6', gap: 8 },
  ...
  sizeSection: { backgroundColor: 'rgba(255, 255, 255, 0.98)', marginHorizontal: 20, marginBottom: 20, borderRadius: 12, padding: 20 },
  ...
  previewSection: { backgroundColor: 'rgba(255, 255, 255, 0.98)', marginHorizontal: 20, marginBottom: 20, borderRadius: 12, padding: 20 },
  ...
  actionButtonSecondary: { backgroundColor: 'rgba(255, 255, 255, 0.98)', borderWidth: 2, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 16, borderRadius: 12, gap: 10 },
